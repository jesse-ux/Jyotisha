...
| 案例 | DK(7星) | DK(8星) | 同? | 7星DT | 7星DK激 | 7星UL | 7星Da | 7星分 | 8星DT | 8星DK激 | 8星UL | 8星Da | 8星分 |
|------|---------|---------|-----|-------|--------|-------|-------|-------|-------|--------|-------|-------|-------|
| 奥巴马 | Saturn@摩羯 | Sun@狮子 | ❌ | ❌ | ✅P | ❌ | ✅ | **2** | ❌ | ✅J | ❌ | ❌ | 1 |
| 克林顿 | Venus@天秤 | Jupiter@天秤 | ❌ | ✅ | ✅J | ❌ | ✅ | **3** | ✅ | ✅J | ❌ | ✅ | 3 |
| 比尔盖茨 | Jupiter@狮子 | Jupiter@狮子 | ✅ | ❌ | ✅J | ✅ | ✅ | **3** | ❌ | ✅J | ✅ | ✅ | 3 |
| 特朗普 | Saturn@巨蟹 | Rahu@金牛 | ❌ | ✅ | ✅P | ✅ | ✅ | **4** | ✅ | ✅J | ✅ | ❌ | 2 |
| 朱莉 | Sun@白羊 | Moon@天秤 | ❌ | ❌ | ✅J | ❌ | ✅ | **2** | ✅ | ✅J | ✅ | ✅ | **4** |
| 贝克汉姆 | Sun@水瓶 | Venus@金牛 | ❌ | ❌ | ✅J | ✅ | ❌ | **2** | ❌ | ✅J | ✅ | ❌ | 2 |
| 乔丹 | Venus@摩羯 | Mars@摩羯 | ❌ | ❌ | ✅P | ❌ | ❌ | **1** | ❌ | ✅P | ❌ | ❌ | 1 |
| 梅根 | Sun@处女 | Venus@处女 | ❌ | ❌ | ✅J | ❌ | ✅ | **2** | ❌ | ✅J | ❌ | ✅ | 2 |
| 马斯克 | Moon@双子 | Jupiter@天蝎 | ❌ | ❌ | ✅P | ❌ | ✅ | **2** | ❌ | ✅J | ✅ | ✅ | 3 |
| 凯特王妃 | Venus@摩羯 | Venus@摩羯 | ✅ | ❌ | ✅J | ✅ | ✅ | **3** | ❌ | ✅J | ✅ | ✅ | 3 |

> P=Parashari相位, J=Jaimini星座相位

### 双轨统计对比

| 技法 | 7星命中率 | 8星命中率 | 评价 |
|------|----------|----------|------|
| DK木星激活 | **9/10 (90%)** | **10/10 (100%)** | 7星稍低但仍极高，Jaimini覆盖面问题仍存 |
| Dasha支持 | 7/10 (70%) | 7/10 (70%) | 两系统一致（基于Moon，不受Karaka影响） |
| UL激活 | 4/10 (40%) | 6/10 (60%) | 8星略优 |
| Double Transit | 2/10 (20%) | 4/10 (40%) | 两系统均偏低，进一步确认不应做唯一判据 |

| 总分分布 | 7星 | 8星 |
|---------|-----|-----|
| ≥3/4 | 3/10 (30%) | 4/10 (40%) |
| ≥2/4 | 10/10 (100%) | 9/10 (90%) |
| 7星更优 | 奥巴马(+1), 特朗普(+2) | — |
| 8星更优 | — | 朱莉(+2), 马斯克(+1) |

### 关键发现（新增2026-04-25）

1. **DK不同占80%**（8/10）——两系统在大多数命盘给出不同DK
2. **Saturn DK 在7星系统中强势**：当7星DK=Saturn时，常与7宫主重合（奥巴马、特朗普），Dasha自动命中
3. **Rahu DK在8星系统中偏弱**：特朗普8星DK=Rahu仅2/4分
4. **DK相同案例仅2个**（盖茨、凯特）——两系统完全一致罕见
5. **一楠的对比**：7星DK=Mars@Cancer(落陷) vs 8星DK=Sun@Aries(入庙) = **完全不同的配偶画像**
...
### 高优先级
- [x] **7星系统名人验证**：已完成（2026-04-25），7星≥3/4=30%, 8星≥3/4=40%, DK不同率80%
- [ ] **随机对照实验**：对每个案例取结婚日±1年的随机日期，检验4技法命中率基线
- [ ] **DK精确度数激活**：木星过境DK精确度数±5°以内的命中率
- [ ] **Navamsha落点检验**：木星/土星过境DK的D9星座
- [ ] **一楠历史分析修正**：AK=Jupiter非Venus, 8星DK=Sun非Rahu, 7星DK=Mars需纳入
