"""Public synthetic-fixture contract shared with the backup repository."""
...
def test_compatibility_payload_normalizes_engine_degree_field() -> None:
    ...
    chart = {
        ...
        "planets": {planet: {"sign": "Aries", "degree": float(index)} for index, planet in enumerate(contract.PLANETS)},
    }
