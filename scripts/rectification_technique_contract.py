...
def build_rectification_technique_contract(*, event_count: int, domain_count: int) -> dict[str, Any]:
    ...
    return {
        ...
        "used_arudha": [],
        "dasha_tracks": ["vimshottari_md_ad", "narayana_md_ad"],
        "missing_layers": ["D2", "D11", "A7", "UL", "A10", "vimshottari_pratyantar", "controlled_transit", "functional_benefic_malefic", "ashtakavarga", "shadbala"],
