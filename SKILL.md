...
**创建日期**：2026-04-20
**最后更新**：2026-06-05（v6.0.35 继续对齐 PyJHora/B.V. Raman 高影响 Yoga 条件，重点收窄 Top FP 并修复 Kahala 映射；当前 473 条 JSON 规则、379 条启用规则，D1/Rasi 逻辑验证 F1=76.08%，报告以 `references/validation_logic_report.json` 为准）
